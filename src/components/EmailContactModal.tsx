...
export default function EmailContactModal({ isOpen, onClose }: EmailContactModalProps) {
  ...
  const emailAddress = "kattyprivemadrid@gmail.com";
  const emailSubject = encodeURIComponent("Consulta Colección • Katty Privé Madrid");
  const emailBody = encodeURIComponent("Estimado equipo de Katty Privé,\n\nDeseo recibir información y asesoramiento sobre sus creaciones.\n\nAtentamente,\n");
  ...
  const whatsappUrl = `https://wa.me/34632892657?text=${encodeURIComponent("Hola Katty Privé, quisiera consultar información sobre sus colecciones y piezas exclusivas.")}`;
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center space-y-3 pb-6 border-b border-[#c5a880]/20">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-[#8c1d27]/10 text-[#8c1d27] text-[10px] font-mono uppercase tracking-widest font-semibold">
              <Sparkles size={11} className="text-[#c5a880]" />
              Atención y Asesoramiento Maison
            </div>
            <h3 className="font-serif text-xl sm:text-2xl font-light text-[#120002] tracking-wide">
              Contacto por Correo Electrónico
            </h3>
            <p className="text-xs text-stone-600 font-light leading-relaxed max-w-sm mx-auto">
              Escríbanos directamente para solicitudes privadas, pedidos de alta joyería o consultas de alta costura.
            </p>
          </div>
          ...
          <div className="my-6 p-4 rounded-sm bg-white border border-[#c5a880]/30 shadow-2xs space-y-2">
            <span className="text-[10px] uppercase font-mono tracking-widest text-[#c5a880] block font-semibold">
              Dirección Oficial de la Maison
            </span>
          ...
          <div className="space-y-2.5">
            ...
            <div className="pt-2">
              ...
              >
                ...
                <span>¿Prefiere contactar por WhatsApp? +34 632 89 26 57</span>
              </a>
            </div>
          </div>
        </motion.div>
