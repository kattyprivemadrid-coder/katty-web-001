...
📍 Visítanos en nuestra boutique privada en Madrid o solicita envío de cortesía asegurado a toda España.
📲 Pedidos y reservas inmediatas por WhatsApp: +34 632 89 26 57
🌐 Tienda online oficial: https://kattyprivemadrid.netlify.app/
...
Pide la tuya por mensaje directo o WhatsApp al +34 632 89 26 57.
🌐 Ver colección completa: https://kattyprivemadrid.netlify.app/
Envíos de cortesía asegurados 24/48h.

#kattyprive #kattyprivemadrid #altacostura #modamadrid #tiktokfashion #lujo #madrid`;
...
🌐 Puedes ver todos los detalles y fotos en nuestra web:
https://kattyprivemadrid.netlify.app/

¿Te gustaría que te reserve una unidad o ver más fotos?`;
      ...
      >
        ...
        <div className="bg-stone-100 px-6 py-3 flex items-center justify-between border-t border-stone-200 text-[11px] text-stone-600">
          <div className="flex items-center gap-1.5 text-stone-500">
            ...
            <span>Herramienta exclusiva de Katty Privé Madrid</span>
          </div>
          <button
            onClick={onClose}
